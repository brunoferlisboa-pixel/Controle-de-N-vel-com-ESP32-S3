# Sistema de Monitoramento Volumétrico Inteligente com ESP32-S3
Este projeto consiste em um sistema residencial/industrial de monitoramento de nível de líquido utilizando o microcontrolador ESP32-S3. O sistema conta com sinalização visual por LEDs, alertas sonoros por bipes em frequências distintas para estados críticos de nível mínimo e máximo, e um painel web dinâmico e responsivo acessível via IP local.
## 🚀 Funcionalidades
*   **Monitoramento em Tempo Real:** Leitura de sensores de nível configurados com resistores de pulldown internos do microcontrolador.
*   **Controle Dinâmico de LEDs:** 
    ...
    *   **Nível Máximo (100%):** LEDs Verde e Amarelo acesos fixos; LED Vermelho acende por 1s, pisca em sincronia com la sirene rápida de transbordo e retorna a ficar aceso fixo em loop.
*   **Painel Web Premium:** Interface moderna em Português (BR) com efeito visual de ondulação da água, status dinâmico colorido/piscante e monitoramento de tensão (5.1V fictício).
